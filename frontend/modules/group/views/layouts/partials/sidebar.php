    ...
    <div class="row">
        ...
        <div class="col-xs-12 sidebar-bottom">
            <div class="list-group list-group-custom bg-grey">
                ...
                echo Html::a(
                    Html::img('@frontendImg/attendance-new.svg') . Html::beginTag('span') . 'Attendance' . Html::endTag('span'),
                    ['/group/attendance/index'],
                    ['class' => 'list-group-item list-group-item-custom flex align-items-center']
                ); 

                echo Html::a(
                    Html::img('@frontendImg/homework_new.svg') . Html::beginTag('span') . 'Assignments' . Html::endTag('span'),
                    ['/group/assignment/index'],
                    ['class' => 'list-group-item list-group-item-custom flex align-items-center']
                ); 

                echo Html::a(
                    Html::img('@frontendImg/result-new.svg') . Html::beginTag('span') . 'Assignment results' . Html::endTag('span'),
